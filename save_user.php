...
if (!isset($fupload) or empty($fupload) or $fupload == '') {
    ...
    $avatar = "avatars/net-avatara.png"; //можете    нарисовать net-avatara.jpg или взять в исходниках
} else {
...
$result2 = mysqli_query($link, "INSERT INTO users (login,password,avatar) VALUES('$login','$password','$avatar')");
